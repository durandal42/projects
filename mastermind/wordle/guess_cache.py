...
def cache(dictionary='wordle', hard=False):
  ...
  elif dictionary == 'nerdle6': return NERDLE6_CACHE
  elif dictionary == 'nerdle8': return NERDLE8_CACHE
  return {}
...
def hard_branches(c):
  ...
  for k, v in c.items():
    ...
    if biggest_bucket > 10:
      ...
      result.append((biggest_bucket, 'RAISE', wordle.pretty_print(
          score), next_guess, wordle.pretty_print(next_score)))
